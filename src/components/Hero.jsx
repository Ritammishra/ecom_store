...
import img from '../assets/wave-haikei.png'
            ...
            <section class="text-white body-font bg-bottom bg-no-repeat  bg-cover" style={{backgroundImage: `url(${img})`}}>
                <div class=" container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                    <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                        <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium">Discover Unmatched Style and Convenience
                            <br class="hidden lg:inline-block"/>
                        </h1>
                        <p class="mb-8 leading-relaxed">Explore Our Curated Collection for a Shopping Experience Unlike Any Other</p>
